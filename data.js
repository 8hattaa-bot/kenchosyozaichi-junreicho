...
const PREF_MISSIONS = {
  hokkaido: { eat: ["名物「スープカレー」を専門店で食べる", "「ジンギスカン」を味わう", "二条市場で新鮮な海鮮丼を食べる"], photo: ["時計台の写真を撮る", "さっぽろテレビ塔のご当地キャラ「テレビ父さん」のパネルやグッズを撮る", "狸小路商店街のアーケードを撮る"], location: ["大通公園まで実際に足を運ぶ"] },
  ...
  miyagi: { eat: ["名物「牛タン定食」を食べる", "「ずんだ餅」を味わう", "仙台のご当地グルメ「マーボー焼きそば」を食べる"], photo: ["伊達政宗騎馬像を撮影する", "宮城県庁1階でご当地キャラ「むすび丸」のグッズを撮る", "定禅寺通のケヤキ並木を撮る"], location: ["仙台城跡（青葉城址）まで実際に足を運ぶ"] },
  ...
  gunma: { eat: ["群馬のソウルフード「登利平の鳥めし」を食べる", "名物「焼きまんじゅう」を味わう", "「ひもかわうどん」を食べる"], photo: ["前橋公園・前橋城跡を撮影する", "群馬県庁の県民センターでご当地キャラ「ぐんまちゃん」のグッズを撮る", "群馬県庁32階展望ホールから街を撮る"], location: ["前橋公園まで実際に足を運ぶ"] },
  ...
  nagano: { eat: ["善光寺門前で「そば」を食べる", "「おやき」を味わう", "「みそすき丼」を食べる"], photo: ["善光寺本堂を撮影する", "仁王門を撮る", "長野駅ビルMIDORIのご当地キャラ「アルクマ」と写真を撮る"], location: ["善光寺まで実際に足を運ぶ"] },
  ...
  nara: { eat: ["「柿の葉寿司」を食べる", "奈良名物「茶粥」を味わう", "奈良漬けを使った料理を食べる"], photo: ["東大寺大仏殿を撮影する", "奈良公園の鹿を撮る", "奈良県庁前のご当地キャラ「せんとくん」立像を撮る"], location: ["奈良公園まで実際に足を運ぶ"] },
  ...
  shimane: { eat: ["「出雲そば」を食べる", "宍道湖のしじみ汁を味わう", "「どじょう掬い饅頭」を食べる"], photo: ["松江城天守を撮影する", "堀川めぐりの遊覧船を撮る", "島根県物産観光館でご当地キャラ「しまねっこ」のグッズを撮る"], location: ["松江城まで実際に足を運ぶ"] },
  ...
  ehime: { eat: ["「鯛めし」を食べる", "「じゃこ天」を味わう", "郷土菓子「タルト」を食べる"], photo: ["松山城天守を撮影する", "道後温泉本館を撮る", "松山城本丸広場の売店でご当地キャラ「みきゃん」のグッズを撮る"], location: ["道後温泉本館まで実際に足を運ぶ"] },
  ...
  kumamoto: { eat: ["「熊本ラーメン」を食べる", "馬刺しを味わう", "「太平燕（タイピーエン）」を食べる"], photo: ["熊本城天守を撮影する", "水前寺成趣園を撮る", "くまモンスクエアでご当地キャラ「くまモン」の装飾を撮る"], location: ["熊本城まで実際に足を運ぶ"] },
